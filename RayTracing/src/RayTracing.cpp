...
int main()
{
    ...
    auto cameraStandPos = point3(-2, 2, 1);
    auto cameraFocusPos = point3(0, 0, -1);
    auto worldUp = vec3(0, 1, 0);
    auto vfov = 90;
    camera cam(cameraStandPos, cameraFocusPos, worldUp, vfov, aspect_ratio);
